	...
	if line1[1]:
		...
		for val1 in line1:
			...
			if search1:
				...
				searchCheck1 = 1	
		if searchCheck1 == 0:
			sys.stderr.write("Error1a -- cannot find search pattern anywhere in line1 (" + str(search1) + "\t" +  ",".join(map(str, line1)) + ")\n")
		poolMID = line1[2]
		if len(poolMID) == 1:
...
for line2 in file2:
	...
	line2a = line2[0].split('|')[0].split('/')[10]
...
#			placeHolder="PH"
			...
			sys.stderr.write("Error2a -- " + poolID2 + " -- " + str(line2) + "\n")
			placeHolder="PH"
