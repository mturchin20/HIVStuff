...
mv $mainDir1/$TrueFake/$Pheno/$Subset/${File1}.${Subset}.${Pheno}.maf1.skat0.permAll.epacts.PerRankCmSum $mainDir1/$TrueFake/$Pheno/$Subset/${oldNum}.${File1}.${Subset}.${Pheno}.maf1.skat0.permAll.epacts.PerRankCmSum
mv $mainDir1/$TrueFake/$Pheno/$Subset/${File1}.${Subset}.${Pheno}.maf1.skat0.permAll.epacts.NullDistrQQPlotCheck.vs1.jpeg $mainDir1/$TrueFake/$Pheno/$Subset/${oldNum}.${File1}.${Subset}.${Pheno}.maf1.skat0.permAll.epacts.NullDistrQQPlotCheck.vs1.jpeg
...
rm $mainDir1/$TrueFake/$Pheno/$Subset/SUMSTAT/DataProcessing.Pipeline.pt6.All.ptg.HomeCodeSUMSTAT.Analysis.vs1.EPACTS.${TrueFake}.${Subset}.${Pheno}.maf1.skat0.perm*.rnk.SUMSTAT*
