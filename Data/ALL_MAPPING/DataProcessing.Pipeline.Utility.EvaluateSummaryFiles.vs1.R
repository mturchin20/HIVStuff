...
#jpeg(file="/home/pg/michaelt/Data/ALL_MAPPING/OutputFiles/Graphics/DataProcessing.Pipeline.Utility.EvaluateSummaryFiles.vs1.vs2.SummaryfastQPlots.jpeg", height=4000, width=4000, res=300)
#par(mfrow=c(3,2))

#dev.off()

jpeg(file="/home/pg/michaelt/Data/ALL_MAPPING/OutputFiles/Graphics/DataProcessing.Pipeline.Utility.EvaluateSummaryFiles.vs1.vs2.SummaryRegionPlots.jpeg", height=8000, width=4000, res=300)
par(mfrow=c(6,2))
...
jpeg(file="/home/pg/michaelt/Data/ALL_MAPPING/OutputFiles/Graphics/DataProcessing.Pipeline.Utility.EvaluateSummaryFiles.vs1.vs2.SummaryIndvPlots.jpeg", height=10000, width=4000, res=300)
par(mfrow=c(6,2))
