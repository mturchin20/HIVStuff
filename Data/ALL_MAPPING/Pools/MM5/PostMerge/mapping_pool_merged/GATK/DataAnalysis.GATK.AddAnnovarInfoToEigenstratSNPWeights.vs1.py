...
for line1 in file1:
	...
	ChrBP1 = str(line1[0]) + ":" + str(line1[1].split("_")[0])

	if re.search('rs', line1[2]):
		ChrBP1 = line1[2]
...
for line2 in file2:
	...
	if line2[0] in hash1:
		print "\t".join(line2) + "\t" + ",".join(map(str, hash1[line2[0]]))
	else:
		sys.stderr.write("Error1a -- SNP " + str(line2[0]) + " has no entry in the AnnovarAnnotation file. Skipping...\n")
