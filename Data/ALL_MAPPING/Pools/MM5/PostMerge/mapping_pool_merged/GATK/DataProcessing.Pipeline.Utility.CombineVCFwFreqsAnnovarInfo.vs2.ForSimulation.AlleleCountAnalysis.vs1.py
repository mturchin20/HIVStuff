...
#File2 Ex: /home/pg/michaelt/Data/ALL_MAPPING/Pools/PostMerge/mapping_pool_merged/GATK/SimulationFiles/AlleleCounts/AllPools.QCed.preGATK.QCed.samplesMerged.rmdup.BQSR.calmd.AllPoolsMerged.ChrAll.GATK.ReduceReads.UG.VQSR.SNP.PASS.wAA.DropOffTargetVariants.1kbWindow.95geno.recode.WhiteOnly.QCed.justSeroNeg.permuteVsAll.frq.count.gz
...
#			hash1[ChrBP1] = [line1[0], line1[1], line1[7]]
...
#			sys.stderr.write("Happening!\n")
			...
			multiTranscript=1			
			multiTranscriptsArray.extend([line3[1], line3[2]])
			i=3
...
#			tempHash1[ChrBP3].insert(8, list(itertools.chain.from_iterable([[line3[0], line3[1], line3[SynnonSynLocation]], line3[len(line3)-19:len(line3)+1]])))
			tempHash1[ChrBP3][9:9] = list(itertools.chain.from_iterable([[line3[0], line3[1], line3[SynnonSynLocation]], line3[len(line3)-19:len(line3)+1]]))
...
#				tempHash1[ChrBP3new].insert(8, list(itertools.chain.from_iterable([[line3[0], multiTranscriptsArray[j], line3[SynnonSynLocation]], line3[len(line3)-19:len(line3)+1]])))
				tempHash1[ChrBP3new][9:9] = list(itertools.chain.from_iterable([[line3[0], multiTranscriptsArray[j], line3[SynnonSynLocation]], line3[len(line3)-19:len(line3)+1]]))
#				tempHash1[ChrBP3new].extend(list(itertools.chain.from_iterable([[line3[0], multiTranscriptsArray[j], line3[SynnonSynLocation]], line3[len(line3)-19:len(line3)+1]])))
