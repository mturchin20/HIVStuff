...
for line1Entry in hash1:
#	print "nana1"
	if line1Entry in hash2:
		line2Use = [hash2[line1Entry][0], ",".join(hash1[line1Entry]), ",".join(hash2[line1Entry][8:19])]
...
#		print ",".join(hash1[line1Entry])
		sys.stderr.write(",".join(hash1[line1Entry]) + "\n")
		val4="val5"
