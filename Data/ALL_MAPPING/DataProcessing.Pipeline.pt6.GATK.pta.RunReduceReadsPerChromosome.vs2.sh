...
/home/shared/software/java/jre1.7.0_09/bin/java -Xmx50g -jar /home/shared/software/GATK/2.1/GenomeAnalysisTK.jar -R ${refFile1} -T ReduceReads -I ${mainDir1}/${baseFileN}.bam -o ${baseFileN}.ReduceReads.bam
