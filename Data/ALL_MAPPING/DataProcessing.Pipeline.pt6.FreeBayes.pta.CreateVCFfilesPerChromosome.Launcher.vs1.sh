...
do
	...
	qsubout="${mainDir1}/qsubout/qsubout.${baseFile1}.Chr${i}.FreeBayes.txt"
	qsubouttemp="${mainDir1}/qsubout/qsubout.${baseFile1}.Chr${i}.FreeBayes.txt_temp"
	qsuboutAll="${mainDir1}/qsubout/qsubout.All.${baseFile1}.Chr${i}.FreeBayes.txt"
	qsuboutAlltemp="${mainDir1}/qsubout/qsubout.All.${baseFile1}.Chr${i}.FreeBayes.txt_temp"
...
#	mainDir2, baseFile1, refFileFlag1
	...
	qsub -j oe -o $qsubout -e $qsubout -l walltime=720:00:00,mem=6gb,nodes=1:ppn=6 -v mainDir1=$mainDir1,baseFileN=$baseFile1,I=$i,refFileFlag1=$refFileFlag1 DataProcessing.Pipeline.pt6.FreeBayes.pta.CreateVCFfilesPerChromosome.vs1.sh 
