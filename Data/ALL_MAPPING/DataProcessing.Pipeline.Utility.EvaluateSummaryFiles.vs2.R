...
Data2 <- Data2[!is.na(Data2$TotalReadsDroppedPrcnt),]

#jpeg(file="/data/userdata/pg/michaelt/Data/ALL_MAPPING/OutputFiles/Graphics/DataProcessing.Pipeline.Utility.EvaluateSummaryFiles.vs1.vs2.SummaryfastQPlots.jpeg", height=4000, width=4000, res=300)
#par(mfrow=c(3,2))

#dev.off()

jpeg(file=paste("/data/userdata/pg/michaelt/Data/ALL_MAPPING/OutputFiles/Graphics/DataProcessing.Pipeline.Utility.EvaluateSummaryFiles.vs2.", paste(strsplit(as.character(Sys.time()), " ")[[1]][1], strsplit(as.character(Sys.time()), " ")[[1]][2], sep="_"), ".SummaryRegionPlots.jpeg", sep=""), height=8000, width=4000, res=300)
par(mfrow=c(6,2))
...
#PreMerge HSMYABW02.RL1 bases: 87594481 reads: 136792 max: 1731 min: 31 mean: 640.35 median: 719 range: 1701 stddev: 257.11 totalDropped(%): 0 0.0000 minDropped(%): 0 0.0000 UpperBoundThresh: 2183 maxDropped(%): 0 0.0000
#PreMerge HTRRSL401.RL1 bases: 59367775 reads: 108050 max: 1107 min: 31 mean: 549.45 median: 606 range: 1077 stddev: 259.48 totalDropped(%): 0 0.0000 minDropped(%): 0 0.0000 UpperBoundThresh: 2106 maxDropped(%): 0 0.0000

plot(Data1[,23], Data1[,23]/Data1[,6], xlab="Total Reads Dropped", ylab="Total % of Reads Dropped", main="Total fastQ Reads <Min Length Dropped: Count vs. Percent")
abline(lm(Data1[,23]/Data1[,6] ~ Data1[,23]), lwd=2, lty=3, col="RED")
plot(Data1[,28], Data1[,28]/Data1[,6], xlab="Total Reads Dropped", ylab="Total % of Reads Dropped", main="Total fastQ Reads >Max Length Dropped: Count vs. Percent")
abline(lm(Data1[,28]/Data1[,6] ~ Data1[,28]), lwd=2, lty=3, col="RED")
...
plot(Data2$TotalReadsDropped, 100*Data2$TotalReadsDroppedPrcnt, xlab="Total Reads Dropped", ylab="Total % of Reads Dropped", main="Total Reads Dropped: Count vs. Percent")
abline(lm(100*Data2$TotalReadsDroppedPrcnt ~ Data2$TotalReadsDropped), lwd=2, lty=3, col="RED")
mean(100*Data2$TotalReadsDroppedPrcnt)
...
plot(Data2$TotalReadsQ10, 100*Data2$TotalReadsQ10Prcnt, xlab="Total Reads Dropped", ylab="Total % of Reads Dropped", main="Total <Q10 Reads: Count vs. Percent")
abline(lm(199*Data2$TotalReadsQ10Prcnt ~ Data2$TotalReadsQ10), lwd=2, lty=3, col="RED")
mean(100*Data2$TotalReadsQ10Prcnt)
plot(Data2$TotalReadsF4, 100*Data2$TotalReadsF4Prcnt, xlab="F4 Reads", ylab="% of Total Reads", main="Total F4 Reads: Count vs. Percent")
abline(lm(100*Data2$TotalReadsF4Prcnt ~ Data2$TotalReadsF4), lwd=2, lty=3, col="RED")
mean(100*Data2$TotalReadsF4Prcnt)
plot(Data2$TotalReadsF256, 100*Data2$TotalReadsF256Prcnt, xlab="F256 Reads", ylab="% of Total Reads", main="Total F256 Reads: Count vs. Percent")
abline(lm(100*Data2$TotalReadsF256Prcnt ~ Data2$TotalReadsF256), lwd=2, lty=3, col="RED")
mean(100*Data2$TotalReadsF256Prcnt)
...
jpeg(file=paste("/data/userdata/pg/michaelt/Data/ALL_MAPPING/OutputFiles/Graphics/DataProcessing.Pipeline.Utility.EvaluateSummaryFiles.vs1.vs2.", paste(strsplit(as.character(Sys.time()), " ")[[1]][1], strsplit(as.character(Sys.time()), " ")[[1]][2], sep="_"), ".SummaryIndvPlots.jpeg", sep=""), height=10000, width=4000, res=300)
par(mfrow=c(6,2))
...
plot(Data3$TotalReadsPostRmdupDropped, 100*Data3$TotalReadsPostRmdupDroppedPercentage, xlab="Number of Reads Dropped", ylab="% Reads Dropped", main="Reads Dropped Duplicate Removal: # Reads vs. % Reads")
mean(Data3$TotalReadsPostRmdupDropped)
mean(100*Data3$TotalReadsPostRmdupDroppedPercentage)
abline(lm(100*Data3$TotalReadsPostRmdupDroppedPercentage ~ Data3$TotalReadsPostRmdupDropped), lwd=2, lty=3, col="RED")
