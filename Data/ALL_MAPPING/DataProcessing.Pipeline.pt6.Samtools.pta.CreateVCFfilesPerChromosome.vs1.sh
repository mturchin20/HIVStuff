...
#/home/shared/software/samtools/samtools-0.1.19/samtools mpileup -u -r ${I} -f $refFile1 ${mainDir1}/${baseFileN}.bam | /home/shared/software/samtools/samtools-0.1.19/bcftools/bcftools view -bvcg - > ${baseFileN}.Chr${I}.raw.bcf

/home/shared/software/samtools/samtools-0.1.19/samtools mpileup -u -C 50 -r ${I} -f $refFile1 ${mainDir1}/${baseFileN}.bam | /home/shared/software/samtools/samtools-0.1.19/bcftools/bcftools view -bvcg - > ${baseFileN}.Samtools.Chr${I}.C50.raw.bcf
