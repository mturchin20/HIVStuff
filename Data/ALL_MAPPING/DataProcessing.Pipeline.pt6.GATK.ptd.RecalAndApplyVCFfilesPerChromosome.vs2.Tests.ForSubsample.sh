...
#/home/shared/software/java/jre1.7.0_09/bin/java -Xmx5g -jar /home/shared/software/GATK/2.5.2/GenomeAnalysisTK.jar -T VariantAnnotator -R $refFile1 -I /home/pg/michaelt/Data/ALL_MAPPING/Pools/MM5/PostMerge/mapping_pool_merged/AllPools.Vs2.QCed.preGATK.QCed.samplesMerged.rmdup.BQSR.calmd.AllPoolsMerged.bam -o $mainDir1/${baseFileN}.Chr${I}.GATK.ReduceReads.UG.HRun.raw.vcf -A HomopolymerRun --variant $mainDir1/${baseFileN}.Chr${I}.GATK.ReduceReads.UG.raw.vcf

#mv $mainDir1/${baseFileN}.Chr${I}.GATK.ReduceReads.UG.HRun.raw.vcf $mainDir1/${baseFileN}.Chr${I}.GATK.ReduceReads.UG.raw.vcf

/home/shared/software/java/jre1.7.0_09/bin/java -Xmx5g -jar /home/shared/software/GATK/2.5.2/GenomeAnalysisTK.jar -T VariantRecalibrator -R $refFile1 -input $mainDir1/${baseFileN}.Chr${I}.GATK.ReduceReads.UG.raw.vcf -recalFile ${baseFileN}.Chr${I}.GATK.ReduceReads.UG.VQSR.recal -tranchesFile ${baseFileN}.Chr${I}.GATK.ReduceReads.UG.VQSR.tranches -rscriptFile ${baseFileN}.Chr${I}.GATK.ReduceReads.UG.VQSR.plots.R -nt 4 -percentBad .01 -minNumBad 1000 -resource:hapmap,known=false,training=true,truth=true,prior=15.0 /home/michaelt/Software/GATK/2.5.2/resources/hapmap_3.3.b37.vcf -resource:omni,known=false,training=true,truth=true,prior=12.0 /home/michaelt/Software/GATK/2.5.2/resources/1000G_omni2.5.b37.vcf -resource:1000G,known=false,training=true,truth=false,prior=10.0 /home/michaelt/Software/GATK/2.5.2/resources/1000G_phase1.snps.high_confidence.b37.vcf -resource:dbsnp,known=true,training=false,truth=false,prior=2.0 /home/michaelt/Software/GATK/2.5.2/resources/dbsnp_137.b37.excluding_sites_after_129.vcf -an QD -an MQRankSum -an ReadPosRankSum -an FS -an DP -an HaplotypeScore -tranche 100.0 -tranche 99.9 -tranche 99.0 -tranche 90.0 -mode SNP
...
#Using this filter belows includes annotations for what SNPs fall inbetween other tranches -- they just are not called 'PASS'. If us filter level 99.9 everything pretty much 'passes' and can't draw subsets based on the different tranche levels.
/home/shared/software/java/jre1.7.0_09/bin/java -Xmx5g -jar /home/shared/software/GATK/2.5.2/GenomeAnalysisTK.jar -T ApplyRecalibration -R $refFile1 -input $mainDir1/${baseFileN}.Chr${I}.GATK.ReduceReads.UG.raw.vcf -recalFile ${baseFileN}.Chr${I}.GATK.ReduceReads.UG.VQSR.recal -tranchesFile ${baseFileN}.Chr${I}.GATK.ReduceReads.UG.VQSR.tranches -o ${baseFileN}.Chr${I}.GATK.ReduceReads.UG.VQSR.SNP.vcf --ts_filter_level 90 -mode SNP
...
#mv /tmp/$PBS_JOBID/$baseFileN* $mainDir1/GATK/Analyses/P2Subsample/. 
