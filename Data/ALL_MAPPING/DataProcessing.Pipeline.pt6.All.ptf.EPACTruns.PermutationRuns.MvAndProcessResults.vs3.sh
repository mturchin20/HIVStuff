...
/home/shared/software/R-3.0.1/bin/R --vanilla --slave --args < /data/userdata/pg/michaelt/Data/ALL_MAPPING/DataProcessing.Pipeline.Utility.QQPlotUsingPermutations.vs1.R $mainDir1/TruePheno/$Pheno/$Subset/DataProcessing.Pipeline.Utility.CollectPValsPerGeneAcrossMultRuns.vs2.TruePheno.${Pheno}.${Subset}.output.noNAs.Routput $mainDir1/$TrueFake/$Pheno/$Subset/DataProcessing.Pipeline.Utility.CollectPValsPerRankAcrossMultRuns.vs2.${TrueFake}.${Pheno}.${Subset}.output.noNAs.Routput $mainDir1/TruePheno/$Pheno/$Subset/DataProcessing.Pipeline.Utility.CollectPValsPerGeneAcrossMultRuns.vs2.TruePheno.${Pheno}.${Subset}.output.noNAs.Routput.QQPlotUsingPermutations.vs1.jpeg ${array1} ${Pheno}
...
R --vanilla --slave --args < /data/userdata/pg/michaelt/Data/ALL_MAPPING/Pools/MM5/PostMerge/mapping_pool_merged/GATK/DataProcessing.Pipeline.Utility.GetFDRValsPerGeneFromPermutations.vs1.R $mainDir1/TruePheno/$Pheno/$Subset/DataProcessing.Pipeline.Utility.CollectPValsPerGeneAcrossMultRuns.vs2.TruePheno.${Pheno}.${Subset}.output.noNAs.Routput $mainDir1/$TrueFake/$Pheno/$Subset/${File1}.${Subset}.${Pheno}.maf1.skat0.permAll.epacts.justpVals > $mainDir1/TruePheno/$Pheno/$Subset/DataProcessing.Pipeline.Utility.CollectPValsPerGeneAcrossMultRuns.vs1.TruePheno.${Pheno}.${Subset}.output.noNAs.Routput.GetFDRValsPerGeneFromPermutations.vs1.output
...
R --vanilla --slave --args < /data/userdata/pg/michaelt/Data/ALL_MAPPING/DataProcessing.Pipeline.Utility.TrueVsFakePerRankCmSum.vs2.R $mainDir1/TruePheno/$Pheno/$Subset/DataProcessing.Pipeline.Utility.CollectPValsPerGeneAcrossMultRuns.vs2.TruePheno.${Pheno}.${Subset}.output.noNAs.Routput.PerRankCmSum $mainDir1/${TrueFake}/$Pheno/$Subset/DataProcessing.Pipeline.Utility.CollectPValsPerRankAcrossMultRuns.vs2.${TrueFake}.${Pheno}.${Subset}.output.noNAs.PerRankCmSum > $mainDir1/TruePheno/$Pheno/$Subset/DataProcessing.Pipeline.Utility.TrueVsFakePerRankCmSum.vs2.TruePheno.${Pheno}.${Subset}.output 
