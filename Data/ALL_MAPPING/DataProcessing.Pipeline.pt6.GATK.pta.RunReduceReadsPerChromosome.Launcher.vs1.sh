...
do
	...
	qsubout="${mainDir1}/qsubout/qsubout.${baseFile1}.Chr${i}.txt"
	qsubouttemp="${mainDir1}/qsubout/qsubout.${baseFile1}.Chr${i}.txt_temp"
	qsuboutAll="${mainDir1}/qsubout/qsubout.All.${baseFile1}.Chr${i}.txt"
	qsuboutAlltemp="${mainDir1}/qsubout/qsubout.All.${baseFile1}.Chr${i}.txt_temp"
...
#	mainDir2, baseFile1, refFileFlag1
	...
	qsub -j oe -o $qsubout -e $qsubout -l walltime=720:00:00,mem=55gb,nodes=1:ppn=6 -v mainDir1=$mainDir1,baseFileN=${baseFile1}.Chr${i},I=$i,refFileFlag1=$refFileFlag1 /data/userdata/pg/michaelt/Data/ALL_MAPPING/DataProcessing.Pipeline.pt6.GATK.pta.RunReduceReadsPerChromosome.vs2.sh 
