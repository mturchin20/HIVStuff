...
#END
#	echo $qsubout
#	qsubout1="${mainDir}/nasdnasd.out"
#	qsubout2="${mainDir}/nasdnasd.err"
#	totalDir sffFile1

	qsub -j oe -o $qsubout -e $qsubout -l walltime=10:00:00,mem=1gb,nodes=1:ppn=1 -v totalDir=$mainDir,baseFile1=$baseFile DataProcessing.Pipeline.pt1.ConvrtsffFilestoFastq.sh 
