...
qsubout1="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno1.maf1.skat0.run${runNum1}"
qsubout1temp="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno1.maf1.skat0.run${runNum1}_temp"
qsubout1All="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno1.maf1.skat0.run${runNum1}"
qsubout1Alltemp="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno1.maf1.skat0.run${runNum1}_temp"
if [ -e $qsubout1 ] ; then
...
qsubout2="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno2.maf1.skat0.run${runNum1}"
qsubout2temp="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno2.maf1.skat0.run${runNum1}_temp"
qsubout2All="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno2.maf1.skat0.run${runNum1}"
qsubout2Alltemp="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno2.maf1.skat0.run${runNum1}_temp"
if [ -e $qsubout2 ] ; then
...
qsubout3="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno3.maf1.skat0.run${runNum1}"
qsubout3temp="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno3.maf1.skat0.run${runNum1}_temp"
qsubout3All="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno3.maf1.skat0.run${runNum1}"
qsubout3Alltemp="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno3.maf1.skat0.run${runNum1}_temp"
if [ -e $qsubout3 ] ; then
...
qsubout4="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno4.maf1.skat0.run${runNum1}"
qsubout4temp="${mainDir1}/qsubout/qsubout.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno4.maf1.skat0.run${runNum1}_temp"
qsubout4All="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno4.maf1.skat0.run${runNum1}"
qsubout4Alltemp="${mainDir1}/qsubout/qsubout.All.EPACTruns.MultiRuns.Launcher.vs3.pt2.${groupfSpecific}.Pheno4.maf1.skat0.run${runNum1}_temp"
if [ -e $qsubout4 ] ; then
