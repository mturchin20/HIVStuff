...
sff_extract -c $baseFile1.sff | gzip > $baseFile1.fastq.gz

: <<'END'

totalReadsPreQC=`zcat $baseFile1.fastq.gz | perl /home/michaelt/Software/prinseq-lite-0.20.3/prinseq-lite.pl -fastq stdin -stats_info | grep reads | awk '{ print $3 }'`
meanLength=`zcat $baseFile1.fastq.gz | perl /home/michaelt/Software/prinseq-lite-0.20.3/prinseq-lite.pl -fastq stdin -stats_len | grep mean | awk '{ print $3 }'`
stdLength=`zcat $baseFile1.fastq.gz | perl /home/michaelt/Software/prinseq-lite-0.20.3/prinseq-lite.pl -fastq stdin -stats_len | grep stddev | awk '{ print $3 }'`
