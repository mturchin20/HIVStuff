...
#	echo $fileDirList
	...
	qsub -j oe -o $qsubout -e $qsubout -l walltime=72:00:00,mem=6gb,nodes=1:ppn=6 -v fileDirList1=$fileDirList DataProcessing.Pipeline.pt3.MergeallSampleBamFiles.vs4.ForP2.vs1.sh 
