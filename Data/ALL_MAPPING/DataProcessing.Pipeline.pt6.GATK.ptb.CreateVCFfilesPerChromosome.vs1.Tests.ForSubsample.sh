...
/home/shared/software/samtools/samtools-0.1.19/samtools view -s ${SubsampleSeed1}.25 -b ${mainDir1}/${baseFileN}.Chr${I}.ReduceReads.bam > ${baseFileN}.Chr${I}.ReduceReads.P2Subsample.bam 
/home/shared/software/samtools/samtools-0.1.19/samtools index ${baseFileN}.Chr${I}.ReduceReads.P2Subsample.bam ${baseFileN}.Chr${I}.ReduceReads.P2Subsample.bai

/home/shared/software/java/jre1.7.0_09/bin/java -Xmx5g -jar /home/shared/software/GATK/2.5.2/GenomeAnalysisTK.jar -T UnifiedGenotyper -R $refFile1 -I ${baseFileN}.Chr${I}.ReduceReads.P2Subsample.bam -L ${I} --dbsnp /home/michaelt/Software/GATK/2.5.2/resources/dbsnp_137.b37.vcf -stand_call_conf 50 -stand_emit_conf 10 -dcov 250 -glm BOTH -nct 6 -o ${baseFileN}.Chr${I}.GATK.ReduceReads.P2Subsample.UG.raw.vcf 
...
gzip ${baseFileN}.Chr${I}.GATK.ReduceReads.P2Subsample.UG.raw.vcf
